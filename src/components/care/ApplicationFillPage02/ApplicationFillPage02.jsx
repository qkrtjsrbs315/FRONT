...
const ApplicationFillPage02 = () => {
  ...
  const handleRadioChange01 = (value) => {
    setSelectedOption01(value === selectedOption01 ? null : value);
  };

  const handleRadioChange02 = (value) => {
    setSelectedOption02(value === selectedOption02 ? null : value);
  };
